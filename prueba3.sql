...
-- Diseño de Tablas del Data Warehouse
CREATE TABLE Dim_Agente (
    AgenteKey    NUMBER PRIMARY KEY, -- Llave subrogada
    AgenteID     NUMBER,
    Nombre       VARCHAR2(50),
...
CREATE TABLE Dim_Incidente (
    IncidenteKey NUMBER PRIMARY KEY, -- Llave subrogada
    IncidenteID  NUMBER,
...
-- Consulta analítica sobre las tablas transaccionales originales
SELECT 
    ag.Nombre, 
